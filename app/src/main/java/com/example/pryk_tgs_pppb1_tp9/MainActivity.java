...
public class MainActivity extends AppCompatActivity {
    ...
    Button notifyButton, cancelButton, updateButton;
    ...
    public void sendNotification(){
        ...
        Intent notificationIntent = new Intent(this, AnotherActivities.class);
    ...
    public void setUpdateButtonNotification(){
        Bitmap androidImage = BitmapFactory.decodeResource(getResources(),R.drawable.starter_image);
        int notificationId = 0;
